...
const VALORES = [
  {
    ...
    desc: 'Cada pieza nace de un proceso creativo único, pensada para el espacio y quien lo habita.',
  },
  {
    num: '02',
    titulo: 'Materiales nobles',
    desc: 'Madera maciza, metal, vidrio y tapizados de calidad. Seleccionamos cada material con criterio.',
  },
  {
    num: '03',
    titulo: 'Fabricación local',
    desc: 'Todo se produce en nuestro taller en Asunción. Control total sobre cada etapa del proceso.',
  },
  {
    num: '04',
    titulo: 'A tu medida',
    desc: 'Las dimensiones, terminaciones y detalles se adaptan a tu espacio y tu visión exactos.',
  },
]

const TIPOS = [
  { icono: '⬛', nombre: 'Mesas & Escritorios', desc: 'Comedor, centro, auxiliares y escritorios de trabajo.' },
  { icono: '▭', nombre: 'Módulos & Estanterías', desc: 'Bibliotecas, aparadores, módulos de TV y walk-in closets.' },
  { icono: '◻', nombre: 'Sillas & Sillones', desc: 'Asientos de diseño con tapizados exclusivos.' },
  { icono: '◈', nombre: 'Camas & Cabeceras', desc: 'Plataformas y cabeceras tapizadas o en madera.' },
  { icono: '◇', nombre: 'Baños & Vanitorios', desc: 'Muebles de baño a medida con materiales resistentes.' },
  { icono: '○', nombre: 'Piezas de exterior', desc: 'Mobiliario para terrazas y espacios al aire libre.' },
]
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20 items-center">
            <FadeIn direction="left">
              ...
              <div className="font-body text-intima-dark/75 leading-relaxed space-y-4">
                <p>
                  En el Taller creemos que el mobiliario es la columna vertebral de un espacio. Un mueble bien diseñado no solo cumple una función — define la identidad del lugar.
                </p>
                <p>
                  Cada pieza que fabricamos comienza con un boceto pensado en conjunto con el cliente. Las medidas, los materiales y los detalles constructivos responden a un espacio concreto y a quien lo usa.
                </p>
                <p>
                  Trabajamos con madera maciza, chapa, metal, vidrio y tapizados de alta calidad. Sin atajos, sin producción en serie.
                </p>
              </div>
            </FadeIn>
      ...
      <section className="py-20 bg-intima-black text-intima-beige">
        <div className="container-site">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-intima-dark/40">
            {TIPOS.map(({ icono, nombre, desc }, i) => (
              <FadeIn key={nombre} delay={i * 0.08}>
                <div className="bg-intima-black p-8 md:p-10 hover:bg-intima-brown/10 transition-colors duration-300 group">
                  <p className="text-2xl mb-5 opacity-40 group-hover:opacity-70 transition-opacity">{icono}</p>
                  <h3 className="font-body font-medium text-intima-sand text-base mb-2">{nombre}</h3>
                  <p className="font-body text-sm text-intima-sand/40 leading-relaxed">{desc}</p>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      <section className="py-20 md:py-28 bg-intima-brown">
        <div className="container-site max-w-2xl mx-auto text-center">
          <FadeIn>
            <p className="font-body text-xs tracking-widest uppercase text-intima-beige/60 mb-5">
              ¿Tenés una pieza en mente?
            </p>
            <h2 className="font-display text-4xl md:text-5xl text-intima-beige mb-6 leading-tight">
              Diseñémosla juntos
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/contacto"
                className="inline-block text-center bg-intima-beige text-intima-brown font-body text-xs tracking-widest uppercase px-10 py-4 hover:bg-intima-black hover:text-intima-beige transition-colors duration-300"
              >
                Contactanos
              </Link>
              <a
